...
class LogoDataset(Dataset):
    ...
    def __getitem__(
        ...
        x1 = self.dataset.imgs[self.memo[im_class][rnd_index_1]][0]
        ...
        if not index % 2:
            ...
            x2 = self.dataset.imgs[self.memo[im_class][rnd_index_2]][0]
            ...
            x2 = self.dataset.imgs[self.memo[im_class_2][rnd_index]][0]
